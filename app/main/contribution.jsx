      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} keyboardVerticalOffset={Platform.OS === 'ios' ? 80 : 20} style={styles.keyboardView}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled" ref={scrollRef} showsVerticalScrollIndicator={false}>
            <View style={styles.header}>
              <TouchableOpacity onPress={() => navigation.goBack()}><Ionicons name="arrow-back" size={20} color="#FF8C00" /></TouchableOpacity>
              <Text style={styles.headerTitle}>Give</Text>
              <View style={styles.headerIcons}>
...
const styles = StyleSheet.create({
  ...
  keyboardView: { flex: 1 },
  container: { flexGrow: 1, paddingHorizontal: 12, paddingVertical: Platform.OS === 'ios' ? -40 : 2, backgroundColor: '#fff' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 8, marginBottom: 12 },
  headerTitle: { fontSize: 18, fontWeight: '700', color: '#333' },
  headerIcons: { flexDirection: 'row' },
  label: { fontSize: 14, fontWeight: '500', marginBottom: 6, color: '#333', marginTop: 8 },
  dropdownContainer: { position: 'relative', marginBottom: 12 },
  customDropdown: { borderWidth: 1, borderColor: '#FF8C00', borderRadius: 6, backgroundColor: '#fff', height: 40, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 8 },
  disabledDropdown: { opacity: 0.5 },
  dropdownText: { fontSize: 14, color: '#333', flex: 1 },
  placeholderText: { color: '#999' },
  dropdownMenu: { borderWidth: 1, borderColor: '#FF8C00', borderRadius: 6, backgroundColor: '#fff', position: 'absolute', top: 42, left: 0, right: 0, zIndex: 1000, maxHeight: 180, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
  dropdownItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, paddingHorizontal: 8 },
  dropdownItemText: { fontSize: 14, color: '#333' },
  frequencyContainer: { flexDirection: 'row', flexWrap: 'wrap', marginBottom: 12, paddingVertical: 6, gap: 6 },
  freqButton: { paddingHorizontal: 10, paddingVertical: 6, backgroundColor: '#FFEFD5', borderRadius: 16, minWidth: 50, alignItems: 'center' },
  freqButtonActive: { backgroundColor: '#FF8C00' },
  freqText: { fontSize: 12, color: '#333', fontWeight: '500', textAlign: 'center' },
  freqTextActive: { color: '#fff' },
  amountBox: { borderWidth: 1, borderColor: '#FF8C00', borderRadius: 6, paddingVertical: 8, paddingHorizontal: 8, marginBottom: 12, alignItems: 'center', backgroundColor: '#fff', minHeight: 70, justifyContent: 'center' },
  currency: { fontSize: 12, color: '#666', marginBottom: 6, fontWeight: '500' },
  amount: { fontSize: 20, fontWeight: '700', color: '#333', textAlign: 'center', width: '100%', minHeight: 28 },
  continueButton: { backgroundColor: '#FF8C00', borderRadius: 6, paddingVertical: 10, paddingHorizontal: 24, alignItems: 'center', marginTop: 12, marginBottom: 16 },
  continueText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  textInput: { borderWidth: 1, borderColor: '#FF8C00', borderRadius: 6, paddingVertical: 8, paddingHorizontal: 8, marginBottom: 8, color: '#333', backgroundColor: '#fff', fontSize: 14, minHeight: 40 },
  ...
  modalContainer: { backgroundColor: '#fff', padding: 12, borderTopLeftRadius: 12, borderTopRightRadius: 12, minHeight: 280, maxHeight: '80%' },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, paddingBottom: 8, borderBottomWidth: 1, borderBottomColor: '#f0f0f0' },
  modalTitle: { fontSize: 18, fontWeight: '700', color: '#333' },
  closeButton: { padding: 6, borderRadius: 12, backgroundColor: '#f5f5f5' },
  networkContainer: { flexDirection: 'row', marginBottom: 8, paddingHorizontal: 2 },
  networkButton: { padding: 6, borderWidth: 1, borderColor: '#fff', borderRadius: 6, marginRight: 8 },
  networkButtonActive: { borderColor: '#FF8C00' },
  networkLogo: { width: 40, height: 40 },
  submitButton: { backgroundColor: '#FF8C00', borderWidth: 1, borderColor: '#FF8C00', borderRadius: 6, paddingVertical: 10, paddingHorizontal: 24, alignItems: 'center', marginTop: 12, width: '100%' },
  submitText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  notificationContainer: { padding: 8, borderRadius: 6, marginBottom: 12, alignItems: 'center' },
  notificationSuccess: { backgroundColor: '#E6FFE6', borderColor: '#00CC00', borderWidth: 1 },
  notificationError: { backgroundColor: '#FFE6E6', borderColor: '#CC0000', borderWidth: 1 },
  notificationText: { fontSize: 14, color: '#333', fontWeight: '500' },
});
